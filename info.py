...
PICS = (environ.get('PICS', 'https://envs.sh/w2b.jpg')).split() #SAMPLE PIC
NOR_IMG = environ.get("NOR_IMG", "https://graph.org/file/e20b5fdaf217252964202.jpg")
MELCOW_VID = environ.get("MELCOW_VID", "https://envs.sh/wRi.jpg")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002266230651').split()] #Channel id for auto indexing ( make sure bot is admin )
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://patelbhavik734:ZxO9kSnNDD8WhJed@boatrixbot.w5eaf.mongodb.net/?retryWrites=true&w=majority&appName=boatrixbot")
DATABASE_NAME = environ.get('DATABASE_NAME', "Boatrixbot")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')


#Auto approve 
CHAT_ID = [int(app_chat_id) if id_pattern.search(app_chat_id) else app_chat_id for app_chat_id in environ.get('CHAT_ID', '').split()]
TEXT = environ.get("APPROVED_WELCOME_TEXT", "<b>{mention},\n\nʏᴏᴜʀ ʀᴇǫᴜᴇsᴛ ᴛᴏ ᴊᴏɪɴ {title} ɪs ᴀᴘᴘʀᴏᴠᴇᴅ.\n\‣ ᴘᴏᴡᴇʀᴇᴅ ʙʏ @boatrixbot</b>")
...
MSG_ALRT = environ.get('MSG_ALRT', 'ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ: boatrix bot')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002358221198')) #Log channel id ( make sure bot is admin )
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/desaisupport') #Support group link ( make sure bot is admin )
